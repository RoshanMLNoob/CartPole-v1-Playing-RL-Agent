# CartPole-v1-Playing-RL-Agent
This is a RL Agent playing the CartPole-v1 game by OpenAI Gymnasium using Q-Learning, 
this is one of my first RL projects ever made using an external library like Gymnasium, other than that I have build only using numpy and matplotlib.
I hope you enjoy!
